...
void TextureManager::LoadTexture(const std::string& filePath)
{
	...
	textureData.srvHandleCPU = dxCommon_->GetCPUDescriptorHandle(srvHeap, descriptorSize, srvIndex);
	textureData.srvHandleGPU = dxCommon_->GetGPUDescriptorHandle(srvHeap, descriptorSize, srvIndex);
